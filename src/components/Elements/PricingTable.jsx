...
export default function PricingTable({ icon,icons, price, title, text,  offers, action }) {
  let getIcon;
  ...
  return (
    <Wrapper className="whiteBg radius8 shadow">
      <div className="flexSpaceCenter">
        {getIcon}
        <p className="font20 extraBold">{price}
        </p>

        <p className="font20 extraBold"> {Icons}
        </p>
      </div>
      ...
      <div style={{ maxWidth: "120px", margin: "30px auto 0 auto" }}>
        <FullButton title="Click" action={action} />
      </div>
    </Wrapper>
  );
}
